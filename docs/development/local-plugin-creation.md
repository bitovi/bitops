...
## 3. Create an ops repo for testing
```
...
### 4.1. BitOps-level BitOps Config
...
## 5. Handling the Plugin Install Script
...
#### 5.2.3. Copy plugin code to the BitOps directory
...
## 6. Handling the Plugin Install Script (remote)
